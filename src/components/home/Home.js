...
function Home() {
  return (
    <div>
        <h1>VNhub</h1>
        <p>Your Gateway to Experiencing Vietnam's Vibrant Culture and Delights!</p>
        <h2>Discover Vietnam's Rich Tapestry of Festivals, Cuisine, and Captivating Destinations</h2>
